...
#import tensorboard_logger as tensorboard_logger #Change3
    ...
    if options.mode == "train":
       ...
       # )
        ...
        trainer = pl.Trainer(
            ...
            default_save_path = [t_logger],
            gpus=None if options.device == "cpu" else options.device,
